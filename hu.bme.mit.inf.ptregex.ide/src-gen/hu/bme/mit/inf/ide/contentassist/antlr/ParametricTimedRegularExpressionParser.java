 ...
 */
package hu.bme.mit.inf.ide.contentassist.antlr;

import com.google.inject.Inject;
import hu.bme.mit.inf.ide.contentassist.antlr.internal.InternalParametricTimedRegularExpressionParser;
...
public class ParametricTimedRegularExpressionParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalParametricTimedRegularExpressionParser createParser() {
		InternalParametricTimedRegularExpressionParser result = new InternalParametricTimedRegularExpressionParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAndAccess().getElementsAssignment_1_1_1(), "rule__And__ElementsAssignment_1_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalParametricTimedRegularExpressionParser typedParser = (InternalParametricTimedRegularExpressionParser) parser;
