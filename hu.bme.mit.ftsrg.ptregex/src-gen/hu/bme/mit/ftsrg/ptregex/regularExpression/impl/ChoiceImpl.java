 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.ptregex.regularExpression.impl.ChoiceImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChoiceImpl extends ExpressionImpl implements Choice
{
  ...
  {
    return RegularExpressionPackage.Literals.CHOICE;
  }
  ...
  public EList<Expression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Expression>(Expression.class, this, RegularExpressionPackage.CHOICE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RegularExpressionPackage.CHOICE__ELEMENTS:
