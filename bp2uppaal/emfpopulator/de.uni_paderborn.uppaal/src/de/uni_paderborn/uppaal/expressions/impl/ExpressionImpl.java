 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.uppaal.expressions.impl.ExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ExpressionImpl extends MinimalEObjectImpl.Container implements Expression {
	...
	public void setExp(String newExp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EXPRESSION__EXP, oldExp, exp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionsPackage.EXPRESSION__EXP:
				return getExp();
		}
