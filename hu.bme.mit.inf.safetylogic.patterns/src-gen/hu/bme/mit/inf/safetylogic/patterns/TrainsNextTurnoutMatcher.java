...
import hu.bme.mit.inf.safetylogic.patterns.util.TrainsNextTurnoutProcessor;
...
public class TrainsNextTurnoutMatcher extends BaseMatcher<TrainsNextTurnoutMatch> {
  ...
  protected TrainsNextTurnoutMatch tupleToMatch(final Tuple t) {
    try {
    	return TrainsNextTurnoutMatch.newMatch((hu.bme.mit.inf.safetylogic.model.railroadmodel.Train) t.get(POSITION_TRAIN), (hu.bme.mit.inf.safetylogic.model.railroadmodel.Turnout) t.get(POSITION_TURNOUT));
  ...
  protected TrainsNextTurnoutMatch arrayToMatch(final Object[] match) {
    try {
    	return TrainsNextTurnoutMatch.newMatch((hu.bme.mit.inf.safetylogic.model.railroadmodel.Train) match[POSITION_TRAIN], (hu.bme.mit.inf.safetylogic.model.railroadmodel.Turnout) match[POSITION_TURNOUT]);
    } catch(ClassCastException e) {
  ...
  protected TrainsNextTurnoutMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return TrainsNextTurnoutMatch.newMutableMatch((hu.bme.mit.inf.safetylogic.model.railroadmodel.Train) match[POSITION_TRAIN], (hu.bme.mit.inf.safetylogic.model.railroadmodel.Turnout) match[POSITION_TURNOUT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
