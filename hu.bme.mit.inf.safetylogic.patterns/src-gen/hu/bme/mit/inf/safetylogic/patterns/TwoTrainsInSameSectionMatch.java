...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.safetylogic.patterns.twoTrainsInSameSection pattern,
 * to be used in conjunction with {@link TwoTrainsInSameSectionMatcher}.
 * 
...
public abstract class TwoTrainsInSameSectionMatch extends BasePatternMatch {
  private Train fT1;
  ...
  private TwoTrainsInSameSectionMatch(final Train pT1, final Train pT2) {
    this.fT1 = pT1;
    this.fT2 = pT2;
  }
  ...
  public List<String> parameterNames() {
    return TwoTrainsInSameSectionMatch.parameterNames;
  }
  ...
  @Override
  public TwoTrainsInSameSectionMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TwoTrainsInSameSectionMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TwoTrainsInSameSectionMatch other = (TwoTrainsInSameSectionMatch) obj;
  ...
  @Override
  public TwoTrainsInSameSectionQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TwoTrainsInSameSectionMatch newEmptyMatch() {
   ...
   * 
   */
  public static TwoTrainsInSameSectionMatch newMutableMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public static TwoTrainsInSameSectionMatch newMatch(final Train pT1, final Train pT2) {
    return new Immutable(pT1, pT2);
  }
  
  private static final class Mutable extends TwoTrainsInSameSectionMatch {
  ...
  private static final class Immutable extends TwoTrainsInSameSectionMatch {
