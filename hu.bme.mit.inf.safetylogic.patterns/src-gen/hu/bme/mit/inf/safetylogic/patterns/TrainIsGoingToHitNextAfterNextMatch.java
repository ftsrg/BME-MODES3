...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.safetylogic.patterns.trainIsGoingToHitNextAfterNext pattern,
 * to be used in conjunction with {@link TrainIsGoingToHitNextAfterNextMatcher}.
 * 
...
public abstract class TrainIsGoingToHitNextAfterNextMatch extends BasePatternMatch {
  private Train fT1;
  ...
  private TrainIsGoingToHitNextAfterNextMatch(final Train pT1, final Train pT2) {
    this.fT1 = pT1;
    this.fT2 = pT2;
  }
  ...
  public List<String> parameterNames() {
    return TrainIsGoingToHitNextAfterNextMatch.parameterNames;
  }
  ...
  @Override
  public TrainIsGoingToHitNextAfterNextMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TrainIsGoingToHitNextAfterNextMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TrainIsGoingToHitNextAfterNextMatch other = (TrainIsGoingToHitNextAfterNextMatch) obj;
  ...
  @Override
  public TrainIsGoingToHitNextAfterNextQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TrainIsGoingToHitNextAfterNextMatch newEmptyMatch() {
   ...
   * 
   */
  public static TrainIsGoingToHitNextAfterNextMatch newMutableMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public static TrainIsGoingToHitNextAfterNextMatch newMatch(final Train pT1, final Train pT2) {
    return new Immutable(pT1, pT2);
  }
  
  private static final class Mutable extends TrainIsGoingToHitNextAfterNextMatch {
  ...
  private static final class Immutable extends TrainIsGoingToHitNextAfterNextMatch {
