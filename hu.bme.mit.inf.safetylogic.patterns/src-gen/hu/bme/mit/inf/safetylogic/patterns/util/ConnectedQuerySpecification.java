...
public final class ConnectedQuerySpecification extends BaseGeneratedEMFQuerySpecification<ConnectedMatcher> {
  ...
  public ConnectedMatch newMatch(final Object... parameters) {
    return ConnectedMatch.newMatch((hu.bme.mit.inf.safetylogic.model.railroadmodel.RailRoadElement) parameters[0], (hu.bme.mit.inf.safetylogic.model.railroadmodel.RailRoadElement) parameters[1]);
  }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      	...
      	}
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_This, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://hu.bme.mit.inf.safetylogic.railroadmodel", "Turnout", "divergent")));
      		new Equality(body, var__virtual_1_, var_connectedTo);
      	...
      	}
      	{
      		...
      		annotation.addAttribute("feature", "connected");
