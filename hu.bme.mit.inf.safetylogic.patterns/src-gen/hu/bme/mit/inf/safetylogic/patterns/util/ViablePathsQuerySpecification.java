...
public final class ViablePathsQuerySpecification extends BaseGeneratedEMFQuerySpecification<ViablePathsMatcher> {
  ...
  public ViablePathsMatch newMatch(final Object... parameters) {
    return ViablePathsMatch.newMatch((hu.bme.mit.inf.safetylogic.model.railroadmodel.RailRoadElement) parameters[0], (hu.bme.mit.inf.safetylogic.model.railroadmodel.Path) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(
      			 ...
      			 new PParameter("path", "hu.bme.mit.inf.safetylogic.model.railroadmodel.Path", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://hu.bme.mit.inf.safetylogic.railroadmodel", "Path")))
      			);
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      	...
      	}
      	{
      		...
      		annotation.addAttribute("feature", "viablePaths");
