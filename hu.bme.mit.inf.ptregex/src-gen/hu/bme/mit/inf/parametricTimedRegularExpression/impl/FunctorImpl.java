 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.parametricTimedRegularExpression.impl.FunctorImpl#getName <em>Name</em>}</li>
 *   <li>{@link hu.bme.mit.inf.parametricTimedRegularExpression.impl.FunctorImpl#getArity <em>Arity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctorImpl extends MinimalEObjectImpl.Container implements Functor
{
  ...
  {
    return ParametricTimedRegularExpressionPackage.Literals.FUNCTOR;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParametricTimedRegularExpressionPackage.FUNCTOR__NAME, oldName, name));
  }
  ...
  public void setArity(int newArity)
  {
    ...
    arity = newArity;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParametricTimedRegularExpressionPackage.FUNCTOR__ARITY, oldArity, arity));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParametricTimedRegularExpressionPackage.FUNCTOR__NAME:
        return getName();
      case ParametricTimedRegularExpressionPackage.FUNCTOR__ARITY:
        return getArity();
    }
