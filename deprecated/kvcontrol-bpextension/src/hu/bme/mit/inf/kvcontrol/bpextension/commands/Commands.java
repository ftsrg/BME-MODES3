package hu.bme.mit.inf.kvcontrol.bpextension.commands;
...
public class Commands {
    ...
    public static final String PASSAGE_REQUEST = "PASSAGE_REQUEST";
    public static final String SHORT_PASSAGE_REQUEST = "SHORT_PASSAGE_REQUEST";
    public static final String PASSAGE_RESPONSE = "PASSAGE_RESPONSE";
