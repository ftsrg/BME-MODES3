...
public class TurnoutWrapper implements ITurnoutStatemachine, Runnable {
    ...
    protected SCITurnout sCITurnout = new SCITurnout() {
        ...
        @Override
        public void raiseRemShortSectionLockFrom(final long value) {
        ...
        public boolean isRaisedSectionLockFromOtherHalfOUT() {
            synchronized (statemachine) {
                return statemachine.getSCITurnout().isRaisedSectionLockFromOtherHalfOUT();
            }
        }
        ...
        public boolean isRaisedRemSectionLockFromOtherHalfOUT() {
            synchronized (statemachine) {
                return statemachine.getSCITurnout().isRaisedRemSectionLockFromOtherHalfOUT();
            }
        }
        ...
        public boolean isRaisedPassingAllowedFromOtherHalfOUT() {
            synchronized (statemachine) {
                return statemachine.getSCITurnout().isRaisedPassingAllowedFromOtherHalfOUT();
            }
        }
