 ...
 * @generated
 */
public class EventAutomatonModelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public EventAutomatonModelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EventAutomatonModelPackage.AUTOMATON: {
				Automaton automaton = (Automaton)theEObject;
				T result = caseAutomaton(automaton);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.TOKEN_PARAMETER_BINDING: {
			...
			case EventAutomatonModelPackage.RESET_TIMER_ACTION: {
			...
			case EventAutomatonModelPackage.SYMBOLIC_INPUT_EVENT: {
			...
			case EventAutomatonModelPackage.SYMBOLIC_TIMER: {
				SymbolicTimer symbolicTimer = (SymbolicTimer)theEObject;
				T result = caseSymbolicTimer(symbolicTimer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.SYMBOLIC_TOKEN_PARAMETER: {
			...
			case EventAutomatonModelPackage.COMPLEX_EVENT_PROCESSOR: {
			...
			case EventAutomatonModelPackage.SYMBOLIC_EVENT: {
				SymbolicEvent symbolicEvent = (SymbolicEvent)theEObject;
				T result = caseSymbolicEvent(symbolicEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.CONSTANT_BINDING: {
			...
			case EventAutomatonModelPackage.SYMBOLIC_EVENT_PARAMETER: {
			...
			case EventAutomatonModelPackage.FREE_PARAMETER: {
			...
			case EventAutomatonModelPackage.SET_TIMER_ACTION: {
			...
			case EventAutomatonModelPackage.SYMBOLIC_TIMEOUT_EVENT: {
			...
			case EventAutomatonModelPackage.BINDING: {
				Binding binding = (Binding)theEObject;
				T result = caseBinding(binding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.FIX_PARAMETER: {
			...
			case EventAutomatonModelPackage.TIMER_ACTION: {
			...
			case EventAutomatonModelPackage.EPSILON_TRANSITION: {
			...
			case EventAutomatonModelPackage.SYMBOLIC_PARAMETER: {
				SymbolicParameter symbolicParameter = (SymbolicParameter)theEObject;
				T result = caseSymbolicParameter(symbolicParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.EVENT: {
				Event event = (Event)theEObject;
				T result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.TOKEN: {
				Token token = (Token)theEObject;
				T result = caseToken(token);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventAutomatonModelPackage.TRANSITION: {
