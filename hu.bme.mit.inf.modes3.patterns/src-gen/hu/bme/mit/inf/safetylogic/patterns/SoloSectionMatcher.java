...
import hu.bme.mit.inf.safetylogic.patterns.util.SoloSectionProcessor;
import hu.bme.mit.inf.safetylogic.patterns.util.SoloSectionQuerySpecification;

/**
 * Generated pattern matcher API of the hu.bme.mit.inf.safetylogic.patterns.soloSection pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link SoloSectionMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see SoloSectionQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class SoloSectionMatcher extends BaseMatcher<SoloSectionMatch> {
  /**
   ...
   * 
   */
  public static SoloSectionMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    SoloSectionMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new SoloSectionMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(SoloSectionMatcher.class);
   ...
   */
  @Deprecated
  public SoloSectionMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public SoloSectionMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a SoloSectionMatch object.
   * 
   */
  public Collection<SoloSectionMatch> getAllMatches(final Section pSection) {
   ...
   * @param pSection the fixed value of pattern parameter section, or null if not bound.
   * @return a match represented as a SoloSectionMatch object, or null if no match is found.
   * 
   */
  public SoloSectionMatch getOneArbitraryMatch(final Section pSection) {
   ...
   * 
   */
  public void forEachMatch(final Section pSection, final IMatchProcessor<? super SoloSectionMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Section pSection, final IMatchProcessor<? super SoloSectionMatch> processor) {
   ...
   * 
   */
  public SoloSectionMatch newMatch(final Section pSection) {
    return SoloSectionMatch.newMatch(pSection);
  }
   ...
   * 
   */
  public static IQuerySpecification<SoloSectionMatcher> querySpecification() throws IncQueryException {
