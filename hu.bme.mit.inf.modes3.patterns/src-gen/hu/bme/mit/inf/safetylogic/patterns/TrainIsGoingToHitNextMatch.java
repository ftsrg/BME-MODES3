...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.safetylogic.patterns.trainIsGoingToHitNext pattern,
 * to be used in conjunction with {@link TrainIsGoingToHitNextMatcher}.
 * 
...
public abstract class TrainIsGoingToHitNextMatch extends BasePatternMatch {
  private Train fT1;
  ...
  private TrainIsGoingToHitNextMatch(final Train pT1, final Train pT2) {
    this.fT1 = pT1;
    this.fT2 = pT2;
  }
  ...
  public List<String> parameterNames() {
    return TrainIsGoingToHitNextMatch.parameterNames;
  }
  ...
  @Override
  public TrainIsGoingToHitNextMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TrainIsGoingToHitNextMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TrainIsGoingToHitNextMatch other = (TrainIsGoingToHitNextMatch) obj;
  ...
  @Override
  public TrainIsGoingToHitNextQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TrainIsGoingToHitNextMatch newEmptyMatch() {
   ...
   * 
   */
  public static TrainIsGoingToHitNextMatch newMutableMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public static TrainIsGoingToHitNextMatch newMatch(final Train pT1, final Train pT2) {
    return new Immutable(pT1, pT2);
  }
  
  private static final class Mutable extends TrainIsGoingToHitNextMatch {
  ...
  private static final class Immutable extends TrainIsGoingToHitNextMatch {
