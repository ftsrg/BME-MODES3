 ...
 * to be used in conjunction with {@link TrainGoingToCutTheTurnoutMatcher}.
 * 
...
public abstract class TrainGoingToCutTheTurnoutMatch extends BasePatternMatch {
  ...
  private TrainGoingToCutTheTurnoutMatch(final Train pTrain, final Turnout pTurnout) {
    this.fTrain = pTrain;
  ...
  public List<String> parameterNames() {
    return TrainGoingToCutTheTurnoutMatch.parameterNames;
  }
  ...
  @Override
  public TrainGoingToCutTheTurnoutMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TrainGoingToCutTheTurnoutMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TrainGoingToCutTheTurnoutMatch other = (TrainGoingToCutTheTurnoutMatch) obj;
  ...
  @Override
  public TrainGoingToCutTheTurnoutQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TrainGoingToCutTheTurnoutMatch newEmptyMatch() {
   ...
   * 
   */
  public static TrainGoingToCutTheTurnoutMatch newMutableMatch(final Train pTrain, final Turnout pTurnout) {
   ...
   * 
   */
  public static TrainGoingToCutTheTurnoutMatch newMatch(final Train pTrain, final Turnout pTurnout) {
    return new Immutable(pTrain, pTurnout);
  }
  
  private static final class Mutable extends TrainGoingToCutTheTurnoutMatch {
  ...
  private static final class Immutable extends TrainGoingToCutTheTurnoutMatch {
