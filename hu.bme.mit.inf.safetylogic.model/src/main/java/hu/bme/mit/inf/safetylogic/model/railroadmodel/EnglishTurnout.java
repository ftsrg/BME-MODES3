 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.safetylogic.model.railroadmodel.EnglishTurnout#getNotConnectedClockwiseSection <em>Not Connected Clockwise Section</em>}</li>
 * </ul>
 *
 * @see hu.bme.mit.inf.safetylogic.model.railroadmodel.ModelPackage#getEnglishTurnout()
 * @model
 * @generated
 */
public interface EnglishTurnout extends Turnout {
	 ...
	 * @see hu.bme.mit.inf.safetylogic.model.railroadmodel.ModelPackage#getEnglishTurnout_NotConnectedClockwiseSection()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.inf.safetylogic.model.railroadmodel.EnglishTurnout#getNotConnectedClockwiseSection <em>Not Connected Clockwise Section</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
