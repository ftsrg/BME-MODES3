 ...
 *   <li>{@link hu.bme.mit.inf.safetylogic.model.RailRoadModel.RailRoadModel#getPaths <em>Paths</em>}</li>
 * </ul>
 *
 * @see hu.bme.mit.inf.safetylogic.model.RailRoadModel.RailRoadModelPackage#getRailRoadModel()
 * @model
 * @generated
 */
public interface RailRoadModel extends EObject {
	 ...
	 * @see hu.bme.mit.inf.safetylogic.model.RailRoadModel.RailRoadModelPackage#getRailRoadModel_Sections()
	 ...
	 * @see hu.bme.mit.inf.safetylogic.model.RailRoadModel.RailRoadModelPackage#getRailRoadModel_Trains()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see hu.bme.mit.inf.safetylogic.model.RailRoadModel.RailRoadModelPackage#getRailRoadModel_Paths()
	 * @model containment="true"
	 * @generated
	 */
	EList<Path> getPaths();
