 ...
 * </ul>
 *
 * @see hu.bme.mit.inf.safetylogic.model.railroadmodel.ModelPackage#getSegment()
 * @model
 * @generated
 */
public interface Segment extends RailRoadElement {
	 ...
	 * @see hu.bme.mit.inf.safetylogic.model.railroadmodel.ModelPackage#getSegment_ConnectedTo()
