...
public interface Train extends EObject {
	 ...
	 * @see #setX(double)
	 * @see hu.bme.mit.inf.safetylogic.model.railroadmodel.ModelPackage#getTrain_X()
	 * @model required="true"
	 * @generated
	 */
	double getX();
	 ...
	 * @see #setY(double)
	 * @see hu.bme.mit.inf.safetylogic.model.railroadmodel.ModelPackage#getTrain_Y()
	 * @model required="true"
	 * @generated
	 */
	double getY();
	 ...
	 * @see #setId(int)
	 * @see hu.bme.mit.inf.safetylogic.model.railroadmodel.ModelPackage#getTrain_Id()
