 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.safetylogic.model.railroadmodel.impl.SegmentImpl#isIsEnabled <em>Is Enabled</em>}</li>
 *   <li>{@link hu.bme.mit.inf.safetylogic.model.railroadmodel.impl.SegmentImpl#getConnectedTo <em>Connected To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SegmentImpl extends RailRoadElementImpl implements Segment {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SEGMENT;
	}
	...
	public void setIsEnabled(boolean newIsEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SEGMENT__IS_ENABLED, oldIsEnabled, isEnabled));
	}
	...
	public EList<RailRoadElement> getConnectedTo() {
		if (connectedTo == null) {
			connectedTo = new EObjectResolvingEList<RailRoadElement>(RailRoadElement.class, this, ModelPackage.SEGMENT__CONNECTED_TO);
		}
		return connectedTo;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SEGMENT__IS_ENABLED:
				return isIsEnabled();
			case ModelPackage.SEGMENT__CONNECTED_TO:
