 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.safetylogic.model.railroadmodel.impl.PathImpl#getFrom <em>From</em>}</li>
 *   <li>{@link hu.bme.mit.inf.safetylogic.model.railroadmodel.impl.PathImpl#getVia <em>Via</em>}</li>
 *   <li>{@link hu.bme.mit.inf.safetylogic.model.railroadmodel.impl.PathImpl#getTo <em>To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathImpl extends MinimalEObjectImpl.Container implements Path {
		...
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.PATH__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(RailRoadElement newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PATH__FROM, oldFrom, from));
	}
	...
	public RailRoadElement getVia() {
		if (via != null && via.eIsProxy()) {
			...
			if (via != oldVia) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.PATH__VIA, oldVia, via));
			}
		}
		return via;
	}
	...
	public void setVia(RailRoadElement newVia) {
		...
		via = newVia;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PATH__VIA, oldVia, via));
	}
	...
	public RailRoadElement getTo() {
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.PATH__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(RailRoadElement newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PATH__TO, oldTo, to));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.PATH__FROM:
				if (resolve) return getFrom();
				return basicGetFrom();
			case ModelPackage.PATH__VIA:
				if (resolve) return getVia();
				return basicGetVia();
			case ModelPackage.PATH__TO:
