...
import hu.bme.mit.ftsrg.qea.model.Parameter;
...
import hu.bme.mit.ftsrg.qea.model.SymbolicTokenParameter;
import hu.bme.mit.ftsrg.qea.model.TimerAction;
import hu.bme.mit.ftsrg.qea.model.Token;
import hu.bme.mit.ftsrg.qea.model.TokenParameterBinding;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see hu.bme.mit.ftsrg.qea.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getAbstractTransition_Eventguard() {
		return (EReference)abstractTransitionEClass.getEStructuralFeatures().get(-1);
	}
	...
	public EAttribute getSymbolicEvent_Name() {
		return (EAttribute)symbolicEventEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getEventGuard_Actions() {
		return (EReference)eventGuardEClass.getEStructuralFeatures().get(-1);
	}
	...
	public EAttribute getSymbolicInputEvent_Name() {
		return (EAttribute)symbolicInputEventEClass.getEStructuralFeatures().get(-1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(abstractTransitionEClass, ABSTRACT_TRANSITION__EVENTGUARD);
		...
		createEReference(eventGuardEClass, EVENT_GUARD__ACTIONS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getState_Acceptor(), ecorePackage.getEBoolean(), "acceptor", null, 1, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAbstractTransition_Eventguard(), this.getEventGuard(), null, "eventguard", null, 1, 1, AbstractTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSymbolicEvent_Name(), ecorePackage.getEString(), "name", null, 1, 1, SymbolicEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEventGuard_Actions(), this.getAction(), null, "actions", null, 0, -1, EventGuard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
