 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.TokenParameterBindingImpl#getBoundTo <em>Bound To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TokenParameterBindingImpl extends BindingImpl implements TokenParameterBinding {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.TOKEN_PARAMETER_BINDING;
	}
		...
		if (boundTo != null && boundTo.eIsProxy()) {
			...
			if (boundTo != oldBoundTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.TOKEN_PARAMETER_BINDING__BOUND_TO, oldBoundTo, boundTo));
			}
		}
		return boundTo;
	}
	...
	public void setBoundTo(SymbolicTokenParameter newBoundTo) {
		...
		boundTo = newBoundTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TOKEN_PARAMETER_BINDING__BOUND_TO, oldBoundTo, boundTo));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.TOKEN_PARAMETER_BINDING__BOUND_TO:
