 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.SymbolicEventImpl#getSymbolicParameters <em>Symbolic Parameters</em>}</li>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.SymbolicEventImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SymbolicEventImpl extends MinimalEObjectImpl.Container implements SymbolicEvent {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SYMBOLIC_EVENT;
	}
	...
	public EList<SymbolicParameter> getSymbolicParameters() {
		if (symbolicParameters == null) {
			symbolicParameters = new EObjectContainmentEList<SymbolicParameter>(SymbolicParameter.class, this, ModelPackage.SYMBOLIC_EVENT__SYMBOLIC_PARAMETERS);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SYMBOLIC_EVENT__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SYMBOLIC_EVENT__SYMBOLIC_PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.SYMBOLIC_EVENT__NAME:
				return getName();
		}
