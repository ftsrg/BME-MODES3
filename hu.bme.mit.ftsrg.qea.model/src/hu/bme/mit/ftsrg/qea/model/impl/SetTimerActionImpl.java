 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.SetTimerActionImpl#getToValue <em>To Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetTimerActionImpl extends TimerActionImpl implements SetTimerAction {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SET_TIMER_ACTION;
	}
	...
	public void setToValue(int newToValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SET_TIMER_ACTION__TO_VALUE, oldToValue, toValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SET_TIMER_ACTION__TO_VALUE:
				return getToValue();
		}
