 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.SymbolicTimeoutEventImpl#getTimer <em>Timer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SymbolicTimeoutEventImpl extends SymbolicEventImpl implements SymbolicTimeoutEvent {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SYMBOLIC_TIMEOUT_EVENT;
	}
	...
	public SymbolicTimer getTimer() {
		if (eContainerFeatureID() != ModelPackage.SYMBOLIC_TIMEOUT_EVENT__TIMER) return null;
	...
	public NotificationChain basicSetTimer(SymbolicTimer newTimer, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTimer, ModelPackage.SYMBOLIC_TIMEOUT_EVENT__TIMER, msgs);
		return msgs;
	}
	...
	public void setTimer(SymbolicTimer newTimer) {
		if (newTimer != eInternalContainer() || (eContainerFeatureID() != ModelPackage.SYMBOLIC_TIMEOUT_EVENT__TIMER && newTimer != null)) {
			...
			if (newTimer != null)
				msgs = ((InternalEObject)newTimer).eInverseAdd(this, ModelPackage.SYMBOLIC_TIMER__TIMEOUT_EVENT, SymbolicTimer.class, msgs);
			msgs = basicSetTimer(newTimer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SYMBOLIC_TIMEOUT_EVENT__TIMER, newTimer, newTimer));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SYMBOLIC_TIMEOUT_EVENT__TIMER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ModelPackage.SYMBOLIC_TIMEOUT_EVENT__TIMER:
				return eInternalContainer().eInverseRemove(this, ModelPackage.SYMBOLIC_TIMER__TIMEOUT_EVENT, SymbolicTimer.class, msgs);
		}
