...
import hu.bme.mit.ftsrg.qea.model.SymbolicParameter;
 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.AutomatonImpl#getStates <em>States</em>}</li>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.AutomatonImpl#getTokens <em>Tokens</em>}</li>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.AutomatonImpl#getInitialState <em>Initial State</em>}</li>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.AutomatonImpl#getSymbolicTokenParameters <em>Symbolic Token Parameters</em>}</li>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.AutomatonImpl#getName <em>Name</em>}</li>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.AutomatonImpl#getTimers <em>Timers</em>}</li>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.AutomatonImpl#getTrapState <em>Trap State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AutomatonImpl extends MinimalEObjectImpl.Container implements Automaton {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.AUTOMATON;
	}
	...
	public EList<State> getStates() {
		if (states == null) {
			states = new EObjectContainmentEList<State>(State.class, this, ModelPackage.AUTOMATON__STATES);
		}
		return states;
	}
	...
	public EList<Token> getTokens() {
		if (tokens == null) {
			tokens = new EObjectResolvingEList<Token>(Token.class, this, ModelPackage.AUTOMATON__TOKENS);
		}
		return tokens;
	}
		...
		if (initialState != null && initialState.eIsProxy()) {
			...
			if (initialState != oldInitialState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.AUTOMATON__INITIAL_STATE, oldInitialState, initialState));
			}
		}
		return initialState;
	}
	...
	public void setInitialState(State newInitialState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AUTOMATON__INITIAL_STATE, oldInitialState, initialState));
	}
	...
	public EList<SymbolicParameter> getSymbolicTokenParameters() {
		if (symbolicTokenParameters == null) {
			symbolicTokenParameters = new EObjectContainmentEList<SymbolicParameter>(SymbolicParameter.class, this, ModelPackage.AUTOMATON__SYMBOLIC_TOKEN_PARAMETERS);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AUTOMATON__NAME, oldName, name));
	}
	...
	public EList<SymbolicTimer> getTimers() {
		if (timers == null) {
			timers = new EObjectContainmentEList<SymbolicTimer>(SymbolicTimer.class, this, ModelPackage.AUTOMATON__TIMERS);
		}
		return timers;
	}
	...
	public State getTrapState() {
		if (trapState != null && trapState.eIsProxy()) {
			...
			if (trapState != oldTrapState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.AUTOMATON__TRAP_STATE, oldTrapState, trapState));
			}
		}
		return trapState;
	}
	...
	public void setTrapState(State newTrapState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AUTOMATON__TRAP_STATE, oldTrapState, trapState));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.AUTOMATON__STATES:
				return ((InternalEList<?>)getStates()).basicRemove(otherEnd, msgs);
			case ModelPackage.AUTOMATON__SYMBOLIC_TOKEN_PARAMETERS:
				return ((InternalEList<?>)getSymbolicTokenParameters()).basicRemove(otherEnd, msgs);
			case ModelPackage.AUTOMATON__TIMERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.AUTOMATON__STATES:
				return getStates();
			case ModelPackage.AUTOMATON__TOKENS:
				return getTokens();
			case ModelPackage.AUTOMATON__INITIAL_STATE:
				if (resolve) return getInitialState();
				return basicGetInitialState();
			case ModelPackage.AUTOMATON__SYMBOLIC_TOKEN_PARAMETERS:
				return getSymbolicTokenParameters();
			case ModelPackage.AUTOMATON__NAME:
				return getName();
			case ModelPackage.AUTOMATON__TIMERS:
				return getTimers();
			case ModelPackage.AUTOMATON__TRAP_STATE:
