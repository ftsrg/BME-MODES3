 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.ConstantBindingImpl#getBoundTo <em>Bound To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstantBindingImpl extends BindingImpl implements ConstantBinding {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.CONSTANT_BINDING;
	}
	...
	public NotificationChain basicSetBoundTo(FixParameter newBoundTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.CONSTANT_BINDING__BOUND_TO, oldBoundTo, newBoundTo);
	...
	public void setBoundTo(FixParameter newBoundTo) {
		if (newBoundTo != boundTo) {
			...
			if (boundTo != null)
				msgs = ((InternalEObject)boundTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CONSTANT_BINDING__BOUND_TO, null, msgs);
			if (newBoundTo != null)
				msgs = ((InternalEObject)newBoundTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CONSTANT_BINDING__BOUND_TO, null, msgs);
			msgs = basicSetBoundTo(newBoundTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CONSTANT_BINDING__BOUND_TO, newBoundTo, newBoundTo));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.CONSTANT_BINDING__BOUND_TO:
