 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.TransitionImpl#getEventguard <em>Eventguard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends AbstractTransitionImpl implements Transition {
	...
	public NotificationChain basicSetEventguard(EventGuard newEventguard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSITION__EVENTGUARD, oldEventguard, newEventguard);
	...
	public void setEventguard(EventGuard newEventguard) {
		if (newEventguard != eventguard) {
			...
			if (eventguard != null)
				msgs = ((InternalEObject)eventguard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TRANSITION__EVENTGUARD, null, msgs);
			if (newEventguard != null)
				msgs = ((InternalEObject)newEventguard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TRANSITION__EVENTGUARD, null, msgs);
			msgs = basicSetEventguard(newEventguard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSITION__EVENTGUARD, newEventguard, newEventguard));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.TRANSITION__EVENTGUARD:
