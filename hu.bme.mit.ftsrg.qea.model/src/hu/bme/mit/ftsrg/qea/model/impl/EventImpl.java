 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.EventImpl#getType <em>Type</em>}</li>
 *   <li>{@link hu.bme.mit.ftsrg.qea.model.impl.EventImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventImpl extends MinimalEObjectImpl.Container implements Event {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.EVENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public EList<FixParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<FixParameter>(FixParameter.class, this, ModelPackage.EVENT__PARAMETERS);
		}
		return parameters;
	}
