...
/**
 * setups for Ethernet communication
 */
void Ethernet_init();
...
/**
 * read Ethernet message, if exists, write byte-data into messageBuffer, returns
 * with the number of readed bytes
 * 
 * @param client pointer to an initialized Ethernet client instance
 * @param messageBuffer where to put data
 * @return the number of readed byte-s
 */
...
/**
 * function for sending reachable sections' via Ethernet
 * 
...
/**
 * function for sending sections' occupancy via Ethernet
 * 
