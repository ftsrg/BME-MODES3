...
public class RuntimeService {
     ...
     * @param cyclePeriod - the fixed rate cycle period for scheduling
     * @return {@code true} if state machine is added properly.
     */
     ...
     *
     * @param statemachine - the statemachine which should be removed
     * @param cyclePeriod - the scheduling cycle period of the statemachine
     * @return {@code true} if state machine is removed properly.
     */
