...
public class RemoteSectionEventListener implements SCISectionsListener {
    ...
    public void onRemPassageRequestToTopRaised() {
        this.sendPassageRequest(Direction.TOP);
    }
    ...
    public void onRemShortPassageRequestToTopRaised() {
        this.sendShortPassageRequest(Direction.TOP);
    }

    @Override
    public void onRemShortPassageRequestToStraightRaised() {
        this.sendShortPassageRequest(Direction.STRAIGHT);
    }

    @Override
    public void onRemPassageAllowedToTopRaised() {
        this.sendPassageAllowed(Direction.TOP);
    }
    ...
    public void onRemPassageDeniedToTopRaised() {
        this.sendPassageDenied(Direction.TOP);
    }
    ...
    private void sendShortPassageRequest(Direction direction) {
        RemoteTurnout remoteTurnout = this.getTurnoutByRemoteDirection(direction);
