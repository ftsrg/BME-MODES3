...
public class TurnoutTraceBuilder extends StatemachineTraceBuilder {
    ...
    public TurnoutTraceBuilder(String traceSavePath) {
        super(StatemachineType.TURNOUT, traceSavePath);
    }

    public TurnoutTraceBuilder(StatemachineType type, String traceSavePath) {
        this(traceSavePath);
    }
