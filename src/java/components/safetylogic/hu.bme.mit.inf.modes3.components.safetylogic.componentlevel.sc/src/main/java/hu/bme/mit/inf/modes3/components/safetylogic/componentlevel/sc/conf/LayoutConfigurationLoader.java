package hu.bme.mit.inf.modes3.components.safetylogic.componentlevel.sc.conf;
...
import hu.bme.mit.inf.modes3.safetylogic.sc.conf.gson.LayoutConfiguration;

public class LayoutConfigurationLoader {

	public static ComponentLayoutConfiguration loadLayoutConfiguration(String pathInResources) throws IOException {
	...
	public ComponentLayoutConfiguration getLayoutConfigurationForComponent(LayoutConfiguration layoutConfiguration, String componentName)
