...
/**
 * Interface a timer has to implement. Use to implement your own timer service.
 * 
 */
public interface ITimer {
	 ...
	 * 
	 * @param isPeriodic
	 *            : Set to true if the time event should be triggered
	 *            periodically
	 */
	 ...
	 * 
	 * @param callback
	 *            : The target callback for which the time event has to be
	 *            unset.
	 * 
	 * @param eventID
	 *            : The time event id.
