 ...
 */
@RunWith(Theories)
class YakinduMessageExternalLocalTranport {
	...
	def void init() {
		...
		val receiverStack = YakinduCommunicationStackFactory::createLocalStackFromDispatcher(receiverDispatcher, new NOPLoggerFactory)
		receiverStack.start
	}
