...
public final class TrainDerailsOnTurnoutNextAfterNextQuerySpecification extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private TrainDerailsOnTurnoutNextAfterNextQuerySpecification() {
   ...
   * 
   */
  public static TrainDerailsOnTurnoutNextAfterNextQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: hu.bme.mit.inf.safetylogic.patterns.internal.TrainDerailsOnTurnoutNextAfterNextQuerySpecification (visibility: PUBLIC, simpleName: TrainDerailsOnTurnoutNextAfterNextQuerySpecification, identifier: hu.bme.mit.inf.safetylogic.patterns.internal.TrainDerailsOnTurnoutNextAfterNextQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.inf.safetylogic.patterns.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: hu.bme.mit.inf.safetylogic.patterns.internal.TrainDerailsOnTurnoutNextAfterNextQuerySpecification (visibility: PUBLIC, simpleName: TrainDerailsOnTurnoutNextAfterNextQuerySpecification, identifier: hu.bme.mit.inf.safetylogic.patterns.internal.TrainDerailsOnTurnoutNextAfterNextQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.inf.safetylogic.patterns.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TrainDerailsOnTurnoutNextAfterNextQuerySpecification INSTANCE = new TrainDerailsOnTurnoutNextAfterNextQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TrainDerailsOnTurnoutNextAfterNextQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.safetylogic.patterns.trainDerailsOnTurnoutNextAfterNext";
    }
