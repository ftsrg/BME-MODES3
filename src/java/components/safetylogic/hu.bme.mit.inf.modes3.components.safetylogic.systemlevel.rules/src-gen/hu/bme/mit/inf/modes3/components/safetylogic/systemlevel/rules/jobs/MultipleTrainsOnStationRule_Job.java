...
public class MultipleTrainsOnStationRule_Job extends CepJob<IObservableComplexEventPattern> {
  public MultipleTrainsOnStationRule_Job(final ActivationState activationState) {
