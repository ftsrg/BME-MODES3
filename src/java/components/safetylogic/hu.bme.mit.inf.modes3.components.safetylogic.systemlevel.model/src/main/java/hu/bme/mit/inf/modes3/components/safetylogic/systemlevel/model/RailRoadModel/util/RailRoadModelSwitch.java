...
public class RailRoadModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RailRoadModelPackage.TURNOUT: {
				Turnout turnout = (Turnout)theEObject;
				T result = caseTurnout(turnout);
				if (result == null) result = caseRailRoadModel_RailRoadElement(turnout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case RailRoadModelPackage.DIMENSION: {
			...
			case RailRoadModelPackage.SEGMENT: {
				...
				if (result == null) result = caseRailRoadModel_RailRoadElement(segment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailRoadModelPackage.PATH: {
	 ...
	 * @generated
	 */
	public T caseRailRoadModel_RailRoadElement(RailRoadElement object) {
		return null;
	}
