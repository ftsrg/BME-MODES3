...
public class ConnectedMatcher extends BaseMatcher<ConnectedMatch> {
  ...
  public static ConnectedMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new ConnectedMatcher(engine);
   ...
   * 
   */
  private ConnectedMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * 
   */
  public Collection<ConnectedMatch> getAllMatches(final EObject pThis, final EObject pConnectedTo) {
   ...
   * 
   */
  public ConnectedMatch getOneArbitraryMatch(final EObject pThis, final EObject pConnectedTo) {
   ...
   * 
   */
  public void forEachMatch(final EObject pThis, final EObject pConnectedTo, final IMatchProcessor<? super ConnectedMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final EObject pThis, final EObject pConnectedTo, final IMatchProcessor<? super ConnectedMatch> processor) {
   ...
   * 
   */
  public ConnectedMatch newMatch(final EObject pThis, final EObject pConnectedTo) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfThis(final ConnectedMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfconnectedTo(final ConnectedMatch partialMatch) {
  ...
  protected ConnectedMatch tupleToMatch(final Tuple t) {
    try {
    	return ConnectedMatch.newMatch((EObject) t.get(POSITION_THIS), (EObject) t.get(POSITION_CONNECTEDTO));
  ...
  protected ConnectedMatch arrayToMatch(final Object[] match) {
    try {
    	return ConnectedMatch.newMatch((EObject) match[POSITION_THIS], (EObject) match[POSITION_CONNECTEDTO]);
    } catch(ClassCastException e) {
  ...
  protected ConnectedMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return ConnectedMatch.newMutableMatch((EObject) match[POSITION_THIS], (EObject) match[POSITION_CONNECTEDTO]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
