...
/**
 * A match processor tailored for the hu.bme.mit.inf.safetylogic.rulepatterns.trainOnStation pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TrainOnStationProcessor implements IMatchProcessor<TrainOnStationMatch> {
  /**
  ...
  @Override
  public void process(final TrainOnStationMatch match) {
    process(match.getT());
  }
}
