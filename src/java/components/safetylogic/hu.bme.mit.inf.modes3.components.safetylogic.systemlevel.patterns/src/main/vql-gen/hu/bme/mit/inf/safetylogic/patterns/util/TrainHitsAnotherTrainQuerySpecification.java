...
public final class TrainHitsAnotherTrainQuerySpecification extends BaseGeneratedEMFQuerySpecification<TrainHitsAnotherTrainMatcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: hu.bme.mit.inf.safetylogic.patterns.util.TrainHitsAnotherTrainQuerySpecification (visibility: PUBLIC, simpleName: TrainHitsAnotherTrainQuerySpecification, identifier: hu.bme.mit.inf.safetylogic.patterns.util.TrainHitsAnotherTrainQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.inf.safetylogic.patterns.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
