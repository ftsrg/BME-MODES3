...
/**
 * A pattern-specific query specification that can instantiate TrainDerailsOnTurnoutNextAfterNextMatcher in a type-safe way.
 * 
 * @see TrainDerailsOnTurnoutNextAfterNextMatcher
 * @see TrainDerailsOnTurnoutNextAfterNextMatch
 * 
 */
@SuppressWarnings("all")
final class TrainDerailsOnTurnoutNextAfterNextQuerySpecification extends BaseGeneratedEMFQuerySpecification<ViatraQueryMatcher<IPatternMatch>> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link TrainDerailsOnTurnoutNextAfterNextQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TrainDerailsOnTurnoutNextAfterNextQuerySpecification#instance()}.
   * 
