...
public abstract class CurrentlyConnectedMatch extends BasePatternMatch {
  ...
  private CurrentlyConnectedMatch(final EObject pThis, final EObject pConnectedTo) {
    this.fThis = pThis;
   ...
   * 
   */
  public static CurrentlyConnectedMatch newMutableMatch(final EObject pThis, final EObject pConnectedTo) {
   ...
   * 
   */
  public static CurrentlyConnectedMatch newMatch(final EObject pThis, final EObject pConnectedTo) {
