...
/**
 * A match processor tailored for the hu.bme.mit.inf.safetylogic.rulepatterns.trainLeftStation pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TrainLeftStationProcessor implements IMatchProcessor<TrainLeftStationMatch> {
  /**
  ...
  @Override
  public void process(final TrainLeftStationMatch match) {
    process(match.getT());
  }
}
