...
public final class TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification() {
   ...
   * 
   */
  public static TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: hu.bme.mit.inf.safetylogic.patterns.internal.TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification (visibility: PUBLIC, simpleName: TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification, identifier: hu.bme.mit.inf.safetylogic.patterns.internal.TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.inf.safetylogic.patterns.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: hu.bme.mit.inf.safetylogic.patterns.internal.TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification (visibility: PUBLIC, simpleName: TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification, identifier: hu.bme.mit.inf.safetylogic.patterns.internal.TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.inf.safetylogic.patterns.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification INSTANCE = new TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TrainHitsAnotherTrainNextAfterNextAfterNextQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.safetylogic.patterns.trainHitsAnotherTrainNextAfterNextAfterNext";
    }
      ...
      try {
          {
              ...
              PVariable var_NextPositionAfterNextPositionAfterNextPosition = body.getOrCreateVariableByName("NextPositionAfterNextPositionAfterNextPosition");
              ...
              new PositivePatternCall(body, new FlatTuple(var_NextPosition, var_NextPositionAfterNextPosition, var_NextPositionAfterNextPositionAfterNextPosition), NextSectionQuerySpecification.instance().getInternalQueryRepresentation());
              ...
              new Equality(body, var__virtual_2_, var_NextPositionAfterNextPositionAfterNextPosition);
              bodies.add(body);
          }
