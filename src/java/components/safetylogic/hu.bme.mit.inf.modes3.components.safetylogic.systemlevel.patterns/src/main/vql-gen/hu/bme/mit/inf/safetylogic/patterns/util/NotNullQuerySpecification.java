...
/**
 * A pattern-specific query specification that can instantiate NotNullMatcher in a type-safe way.
 * 
 * @see NotNullMatcher
 * @see NotNullMatch
 * 
...
final class NotNullQuerySpecification extends BaseGeneratedEMFQuerySpecification<ViatraQueryMatcher<IPatternMatch>> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link NotNullQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link NotNullQuerySpecification#instance()}.
   * 
