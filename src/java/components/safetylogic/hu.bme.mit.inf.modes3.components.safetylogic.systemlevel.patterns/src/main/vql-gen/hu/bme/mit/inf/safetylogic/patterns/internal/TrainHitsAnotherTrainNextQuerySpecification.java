...
public final class TrainHitsAnotherTrainNextQuerySpecification extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: hu.bme.mit.inf.safetylogic.patterns.internal.TrainHitsAnotherTrainNextQuerySpecification (visibility: PUBLIC, simpleName: TrainHitsAnotherTrainNextQuerySpecification, identifier: hu.bme.mit.inf.safetylogic.patterns.internal.TrainHitsAnotherTrainNextQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.inf.safetylogic.patterns.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: hu.bme.mit.inf.safetylogic.patterns.internal.TrainHitsAnotherTrainNextQuerySpecification (visibility: PUBLIC, simpleName: TrainHitsAnotherTrainNextQuerySpecification, identifier: hu.bme.mit.inf.safetylogic.patterns.internal.TrainHitsAnotherTrainNextQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: hu.bme.mit.inf.safetylogic.patterns.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
