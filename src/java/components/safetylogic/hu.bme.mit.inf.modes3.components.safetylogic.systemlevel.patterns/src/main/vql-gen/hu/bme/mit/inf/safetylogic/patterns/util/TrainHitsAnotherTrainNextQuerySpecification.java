...
/**
 * A pattern-specific query specification that can instantiate TrainHitsAnotherTrainNextMatcher in a type-safe way.
 * 
 * @see TrainHitsAnotherTrainNextMatcher
 * @see TrainHitsAnotherTrainNextMatch
 * 
 */
@SuppressWarnings("all")
final class TrainHitsAnotherTrainNextQuerySpecification extends BaseGeneratedEMFQuerySpecification<ViatraQueryMatcher<IPatternMatch>> {
  private TrainHitsAnotherTrainNextQuerySpecification() {
   ...
   * 
   */
  public static TrainHitsAnotherTrainNextQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link TrainHitsAnotherTrainNextQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TrainHitsAnotherTrainNextQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TrainHitsAnotherTrainNextQuerySpecification INSTANCE = new TrainHitsAnotherTrainNextQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TrainHitsAnotherTrainNextQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.safetylogic.patterns.trainHitsAnotherTrainNext";
    }
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(
      			 ...
      			 new PParameter("Victim", "hu.bme.mit.inf.modes3.components.safetylogic.systemlevel.model.RailRoadModel.Train", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://hu.bme.mit.inf.safetylogic.railroadmodel", "Train")))
      			);
    }
      ...
      try {
      	{
      		...
      		new Equality(body, var__virtual_2_, var_NextPosition);
      		bodies.add(body);
      	}
