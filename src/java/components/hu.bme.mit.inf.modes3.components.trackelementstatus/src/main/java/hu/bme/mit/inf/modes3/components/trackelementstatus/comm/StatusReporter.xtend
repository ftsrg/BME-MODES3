package hu.bme.mit.inf.modes3.components.trackelementstatus.comm

import hu.bme.mit.inf.modes3.components.trackelementstatus.comm.json.TrackElementStatusMessage
