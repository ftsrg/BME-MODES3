package hu.bme.mit.inf.modes3.components.trackelementstatus.app

import hu.bme.mit.inf.modes3.components.trackelementstatus.TrackSupervisor
import hu.bme.mit.inf.modes3.components.trackelementstatus.comm.json.JsonDispatcherFactory
import hu.bme.mit.inf.modes3.components.trackelementstatus.wrapper.TrackSupervisorWrapper
...
class Main {
	def static void main(String[] args) {
		...
		val component = new TrackSupervisor
		val componentWrapper = new TrackSupervisorWrapper(component, railwayTrackCommunicationStack,
			segmentCommunicationStack, turnoutCommunicationStack, loggerFactory)
