...
class DccOperationsState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.DccOperationsState) */ {
 public:
  ...
  #if LANG_CXX11
  DccOperationsState(DccOperationsState&& from) noexcept
    : DccOperationsState() {
    *this = ::std::move(from);
  }

  inline DccOperationsState& operator=(DccOperationsState&& from) noexcept {
  ...
  friend void swap(DccOperationsState& a, DccOperationsState& b) {
    a.Swap(&b);
  }
