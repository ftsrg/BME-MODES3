...
class DccOperationsCommand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.DccOperationsCommand) */ {
 public:
  ...
  #if LANG_CXX11
  DccOperationsCommand(DccOperationsCommand&& from) noexcept
    : DccOperationsCommand() {
    *this = ::std::move(from);
  }

  inline DccOperationsCommand& operator=(DccOperationsCommand&& from) noexcept {
  ...
  friend void swap(DccOperationsCommand& a, DccOperationsCommand& b) {
    a.Swap(&b);
  }
