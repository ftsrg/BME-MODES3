...
private:
    ...
    static bool setTrainFunction( int messagePriority, int trainAddress, int trainFunctionNumber, bool trainFunctionState );
    static bool setTurnoutState( int messagePriority, int turnoutAddress, TurnoutState turnoutState );
    static bool setTrainCV( int messagePriority, int trainAddress, int cvRegisterAddress, int cvRegisterData ); // advanced
