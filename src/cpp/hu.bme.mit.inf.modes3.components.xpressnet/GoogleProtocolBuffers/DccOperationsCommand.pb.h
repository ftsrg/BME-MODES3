...
namespace protobuf
{
    ...
    class DccOperationsCommand
        : public ::google::protobuf::
              Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.DccOperationsCommand) */
    {
    public:
        ...
        inline DccOperationsCommand* New() const
        {
            return New(NULL);
        }
    ...
    private:
        ...
        friend void protobuf_AddDesc_DccOperationsCommand_2eproto();
        ...
        static DccOperationsCommand* default_instance_;
    };
// ===================================================================
