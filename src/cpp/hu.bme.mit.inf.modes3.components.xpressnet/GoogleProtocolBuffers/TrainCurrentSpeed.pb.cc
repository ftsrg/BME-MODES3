...
namespace protobuf
{
    ...
    namespace
    {
        ...
        const ::google::protobuf::Descriptor* TrainCurrentSpeed_descriptor_ = NULL;
        const ::google::protobuf::internal::GeneratedMessageReflection* TrainCurrentSpeed_reflection_ = NULL;

    } // namespace

    void protobuf_AssignDesc_TrainCurrentSpeed_2eproto()
    {
        protobuf_AddDesc_TrainCurrentSpeed_2eproto();
        const ::google::protobuf::FileDescriptor* file =
            ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName("TrainCurrentSpeed.proto");
        GOOGLE_CHECK(file != NULL);
        TrainCurrentSpeed_descriptor_ = file->message_type(0);
        static const int TrainCurrentSpeed_offsets_[3] = {
        ...
        TrainCurrentSpeed_reflection_ =
            ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
                TrainCurrentSpeed_descriptor_, TrainCurrentSpeed::default_instance_, TrainCurrentSpeed_offsets_, -1, -1,
                -1, sizeof(TrainCurrentSpeed),
                GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TrainCurrentSpeed, _internal_metadata_),
                GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TrainCurrentSpeed, _is_default_instance_));
    }
    ...
    namespace
    {
        ...
        inline void protobuf_AssignDescriptorsOnce()
        {
            ::google::protobuf::GoogleOnceInit(
                &protobuf_AssignDescriptors_once_, &protobuf_AssignDesc_TrainCurrentSpeed_2eproto);
        }
        ...
        void protobuf_RegisterTypes(const ::std::string&)
        {
            ...
            ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
                TrainCurrentSpeed_descriptor_, &TrainCurrentSpeed::default_instance());
        }

    } // namespace

    void protobuf_ShutdownFile_TrainCurrentSpeed_2eproto()
    {
        delete TrainCurrentSpeed::default_instance_;
        delete TrainCurrentSpeed_reflection_;
    }

    void protobuf_AddDesc_TrainCurrentSpeed_2eproto()
    {
        ...
        TrainCurrentSpeed::default_instance_ = new TrainCurrentSpeed();
        TrainCurrentSpeed::default_instance_->InitAsDefaultInstance();
        ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_TrainCurrentSpeed_2eproto);
    }

    // Force AddDescriptors() to be called at static initialization time.
    struct StaticDescriptorInitializer_TrainCurrentSpeed_2eproto {
        StaticDescriptorInitializer_TrainCurrentSpeed_2eproto()
        {
            protobuf_AddDesc_TrainCurrentSpeed_2eproto();
        }
    } static_descriptor_initializer_TrainCurrentSpeed_2eproto_;
...
// ===================================================================
    ...
    void TrainCurrentSpeed::InitAsDefaultInstance()
    {
    ...
    {
        protobuf_AssignDescriptorsOnce();
        return TrainCurrentSpeed_descriptor_;
    }
    ...
    TrainCurrentSpeed* TrainCurrentSpeed::default_instance_ = NULL;
...
#define ZR_HELPER_(f)                                                                                               \
    _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") __builtin_offsetof( \
        TrainCurrentSpeed, f) _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(&reinterpret_cast<TrainCurrentSpeed*>(16)->f)
#endif
...
#undef ZR_
    ...
    bool TrainCurrentSpeed::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream* input)
    {
        ...
        for(;;) {
            ...
            case 1: {
                ...
                if(input->ExpectTag(16))
                    goto parse_currentSpeed;
                break;
            }

            // optional uint32 currentSpeed = 2;
            case 2: {
                if(tag == 16) {
                parse_currentSpeed:
                    DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive< ::google::protobuf::uint32,
                        ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(input, &currentspeed_)));
...
#undef DO_
    ...
    void TrainCurrentSpeed::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream* output) const
    {
    ...
    ::google::protobuf::uint8* TrainCurrentSpeed::InternalSerializeWithCachedSizesToArray(bool deterministic,
    ...
    int TrainCurrentSpeed::ByteSize() const
    {
        ...
        // optional uint32 currentSpeed = 2;
        if(this->currentspeed() != 0) {
            total_size += 1 + ::google::protobuf::internal::WireFormatLite::UInt32Size(this->currentspeed());
        }
    ...
    void TrainCurrentSpeed::MergeFrom(const ::google::protobuf::Message& from)
    {
        ...
        const TrainCurrentSpeed* source =
            ::google::protobuf::internal::DynamicCastToGenerated<const TrainCurrentSpeed>(&from);
        if(source == NULL) {
    ...
    ::google::protobuf::Metadata TrainCurrentSpeed::GetMetadata() const
    {
        ...
        metadata.descriptor = TrainCurrentSpeed_descriptor_;
        metadata.reflection = TrainCurrentSpeed_reflection_;
        return metadata;
    }
