...
namespace protobuf
{
    ...
    class TurnoutReferenceCommand
        : public ::google::protobuf::
              Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.TurnoutReferenceCommand) */
    {
    public:
        ...
        inline TurnoutReferenceCommand* New() const
        {
            return New(NULL);
        }
    ...
    private:
        ...
        friend void protobuf_AddDesc_TurnoutReferenceCommand_2eproto();
        ...
        static TurnoutReferenceCommand* default_instance_;
    };
// ===================================================================
