...
namespace protobuf
{
    ...
    class SegmentCommand : public ::google::protobuf::
                               Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.SegmentCommand) */
    {
    public:
        SegmentCommand();
        ...
        inline SegmentCommand* New() const
        {
            return New(NULL);
        }
