...
namespace protobuf
{
    ...
    namespace
    {
        ...
        const ::google::protobuf::internal::GeneratedMessageReflection* TrainReferenceSpeed_reflection_ = NULL;
    ...
    void protobuf_AssignDesc_TrainReferenceSpeed_2eproto()
    {
        ...
        const ::google::protobuf::FileDescriptor* file =
            ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName("TrainReferenceSpeed.proto");
        ...
        TrainReferenceSpeed_reflection_ =
            ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
                TrainReferenceSpeed_descriptor_, TrainReferenceSpeed::default_instance_, TrainReferenceSpeed_offsets_,
                -1, -1, -1, sizeof(TrainReferenceSpeed),
                GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TrainReferenceSpeed, _internal_metadata_),
                GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TrainReferenceSpeed, _is_default_instance_));
    }
    ...
    namespace
    {
        ...
        inline void protobuf_AssignDescriptorsOnce()
        {
            ::google::protobuf::GoogleOnceInit(
                &protobuf_AssignDescriptors_once_, &protobuf_AssignDesc_TrainReferenceSpeed_2eproto);
        }
        ...
        void protobuf_RegisterTypes(const ::std::string&)
        {
            ...
            ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
                TrainReferenceSpeed_descriptor_, &TrainReferenceSpeed::default_instance());
        }
    ...
    {
        delete TrainReferenceSpeed::default_instance_;
    ...
    void protobuf_AddDesc_TrainReferenceSpeed_2eproto()
    {
        ...
        TrainReferenceSpeed::default_instance_ = new TrainReferenceSpeed();
        TrainReferenceSpeed::default_instance_->InitAsDefaultInstance();
...
// ===================================================================
    ...
    TrainReferenceSpeed* TrainReferenceSpeed::default_instance_ = NULL;
...
#define ZR_HELPER_(f)                                                                                               \
    _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") __builtin_offsetof( \
        TrainReferenceSpeed, f) _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(&reinterpret_cast<TrainReferenceSpeed*>(16)->f)
#endif
...
#undef ZR_
    ...
    bool TrainReferenceSpeed::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream* input)
    {
...
#undef DO_
    ...
    void TrainReferenceSpeed::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream* output) const
    {
    ...
    ::google::protobuf::uint8* TrainReferenceSpeed::InternalSerializeWithCachedSizesToArray(bool deterministic,
    ...
    int TrainReferenceSpeed::ByteSize() const
    {
    ...
    void TrainReferenceSpeed::MergeFrom(const ::google::protobuf::Message& from)
    {
        ...
        const TrainReferenceSpeed* source =
            ::google::protobuf::internal::DynamicCastToGenerated<const TrainReferenceSpeed>(&from);
        if(source == NULL) {
