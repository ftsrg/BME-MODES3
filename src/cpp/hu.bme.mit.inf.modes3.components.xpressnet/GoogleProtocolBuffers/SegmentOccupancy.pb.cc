...
namespace protobuf
{
    ...
    namespace
    {
        ...
        const ::google::protobuf::internal::GeneratedMessageReflection* SegmentOccupancy_reflection_ = NULL;
    ...
    void protobuf_AssignDesc_SegmentOccupancy_2eproto()
    {
        ...
        const ::google::protobuf::FileDescriptor* file =
            ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName("SegmentOccupancy.proto");
        ...
        SegmentOccupancy_reflection_ =
            ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
                SegmentOccupancy_descriptor_, SegmentOccupancy::default_instance_, SegmentOccupancy_offsets_, -1, -1,
                -1, sizeof(SegmentOccupancy),
                GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SegmentOccupancy, _internal_metadata_),
                GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SegmentOccupancy, _is_default_instance_));
    }
    ...
    namespace
    {
        ...
        inline void protobuf_AssignDescriptorsOnce()
        {
            ::google::protobuf::GoogleOnceInit(
                &protobuf_AssignDescriptors_once_, &protobuf_AssignDesc_SegmentOccupancy_2eproto);
        }
        ...
        void protobuf_RegisterTypes(const ::std::string&)
        {
            ...
            ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
                SegmentOccupancy_descriptor_, &SegmentOccupancy::default_instance());
        }
    ...
    {
        delete SegmentOccupancy::default_instance_;
    ...
    void protobuf_AddDesc_SegmentOccupancy_2eproto()
    {
        ...
        SegmentOccupancy::default_instance_ = new SegmentOccupancy();
        SegmentOccupancy::default_instance_->InitAsDefaultInstance();
...
// ===================================================================
    ...
    SegmentOccupancy* SegmentOccupancy::default_instance_ = NULL;
...
#define ZR_HELPER_(f)                                                                                               \
    _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") __builtin_offsetof( \
        SegmentOccupancy, f) _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(&reinterpret_cast<SegmentOccupancy*>(16)->f)
#endif
...
#undef ZR_
    ...
    bool SegmentOccupancy::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream* input)
    {
...
#undef DO_
    ...
    void SegmentOccupancy::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream* output) const
    {
    ...
    ::google::protobuf::uint8* SegmentOccupancy::InternalSerializeWithCachedSizesToArray(bool deterministic,
    ...
    int SegmentOccupancy::ByteSize() const
    {
    ...
    void SegmentOccupancy::MergeFrom(const ::google::protobuf::Message& from)
    {
        ...
        const SegmentOccupancy* source =
            ::google::protobuf::internal::DynamicCastToGenerated<const SegmentOccupancy>(&from);
        if(source == NULL) {
