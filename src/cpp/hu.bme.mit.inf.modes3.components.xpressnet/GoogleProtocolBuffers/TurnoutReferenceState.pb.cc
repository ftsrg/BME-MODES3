...
namespace protobuf
{
    ...
    namespace
    {
        ...
        const ::google::protobuf::internal::GeneratedMessageReflection* TurnoutReferenceState_reflection_ = NULL;
    ...
    void protobuf_AssignDesc_TurnoutReferenceState_2eproto()
    {
        ...
        const ::google::protobuf::FileDescriptor* file =
            ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName("TurnoutReferenceState.proto");
        ...
        TurnoutReferenceState_reflection_ =
            ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
                TurnoutReferenceState_descriptor_, TurnoutReferenceState::default_instance_,
                TurnoutReferenceState_offsets_, -1, -1, -1, sizeof(TurnoutReferenceState),
                GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TurnoutReferenceState, _internal_metadata_),
                GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TurnoutReferenceState, _is_default_instance_));
    }
    ...
    namespace
    {
        ...
        inline void protobuf_AssignDescriptorsOnce()
        {
            ::google::protobuf::GoogleOnceInit(
                &protobuf_AssignDescriptors_once_, &protobuf_AssignDesc_TurnoutReferenceState_2eproto);
        }
        ...
        void protobuf_RegisterTypes(const ::std::string&)
        {
            ...
            ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
                TurnoutReferenceState_descriptor_, &TurnoutReferenceState::default_instance());
        }
    ...
    {
        delete TurnoutReferenceState::default_instance_;
    ...
    void protobuf_AddDesc_TurnoutReferenceState_2eproto()
    {
        ...
        TurnoutReferenceState::default_instance_ = new TurnoutReferenceState();
        TurnoutReferenceState::default_instance_->InitAsDefaultInstance();
...
// ===================================================================
    ...
    TurnoutReferenceState* TurnoutReferenceState::default_instance_ = NULL;
...
#define ZR_HELPER_(f)                                                                                               \
    _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") __builtin_offsetof( \
        TurnoutReferenceState, f) _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(&reinterpret_cast<TurnoutReferenceState*>(16)->f)
#endif
...
#undef ZR_
    ...
    bool TurnoutReferenceState::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream* input)
    {
...
#undef DO_
    ...
    void TurnoutReferenceState::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream* output) const
    {
    ...
    ::google::protobuf::uint8* TurnoutReferenceState::InternalSerializeWithCachedSizesToArray(bool deterministic,
    ...
    int TurnoutReferenceState::ByteSize() const
    {
    ...
    void TurnoutReferenceState::MergeFrom(const ::google::protobuf::Message& from)
    {
        ...
        const TurnoutReferenceState* source =
            ::google::protobuf::internal::DynamicCastToGenerated<const TurnoutReferenceState>(&from);
        if(source == NULL) {
