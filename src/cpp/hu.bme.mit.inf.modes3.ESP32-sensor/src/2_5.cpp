...
const int proxitySensorPin[2] = {34, 35}; // DIGITAL infra inputs
const double hossz = 6.5; // sensor distance
const double maxtime=4;
const double prelltime=0.04;
char str[60];
char strg[30];
...
InfSensor Sensor[2]={InfSensor(34),InfSensor(35)};
