...
class TurnoutCommand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.TurnoutCommand) */ {
 public:
  ...
  static const TurnoutCommand* internal_default_instance();

  void Swap(TurnoutCommand* other);

  // implements Message ----------------------------------------------

  inline TurnoutCommand* New() const { return New(NULL); }
  ...
  void UnsafeMergeFrom(const TurnoutCommand& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_TurnoutCommand_2eproto_impl();
  friend void  protobuf_AddDesc_TurnoutCommand_2eproto_impl();
  friend void protobuf_AssignDesc_TurnoutCommand_2eproto();
  friend void protobuf_ShutdownFile_TurnoutCommand_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<TurnoutCommand> TurnoutCommand_default_instance_;
