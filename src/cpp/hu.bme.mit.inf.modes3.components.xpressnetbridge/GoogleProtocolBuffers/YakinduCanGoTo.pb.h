...
class YakinduCanGoTo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.YakinduCanGoTo) */ {
 public:
  ...
  static const YakinduCanGoTo* internal_default_instance();

  void Swap(YakinduCanGoTo* other);

  // implements Message ----------------------------------------------

  inline YakinduCanGoTo* New() const { return New(NULL); }
  ...
  void UnsafeMergeFrom(const YakinduCanGoTo& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_YakinduCanGoTo_2eproto_impl();
  friend void  protobuf_AddDesc_YakinduCanGoTo_2eproto_impl();
  friend void protobuf_AssignDesc_YakinduCanGoTo_2eproto();
  friend void protobuf_ShutdownFile_YakinduCanGoTo_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<YakinduCanGoTo> YakinduCanGoTo_default_instance_;
