...
class TurnoutReferenceState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.TurnoutReferenceState) */ {
 public:
  ...
  static const TurnoutReferenceState* internal_default_instance();
  ...
  void UnsafeMergeFrom(const TurnoutReferenceState& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_TurnoutReferenceState_2eproto_impl();
  friend void  protobuf_AddDesc_TurnoutReferenceState_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<TurnoutReferenceState> TurnoutReferenceState_default_instance_;
