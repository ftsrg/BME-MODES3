...
const ::google::protobuf::internal::GeneratedMessageReflection*
  TurnoutReferenceCommand_reflection_ = NULL;

}  // namespace


void protobuf_AssignDesc_TurnoutReferenceCommand_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_TurnoutReferenceCommand_2eproto() {
  ...
  TurnoutReferenceCommand_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      TurnoutReferenceCommand_descriptor_,
      TurnoutReferenceCommand::internal_default_instance(),
      TurnoutReferenceCommand_offsets_,
      -1,
      -1,
      -1,
      sizeof(TurnoutReferenceCommand),
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_TurnoutReferenceCommand_2eproto);
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      TurnoutReferenceCommand_descriptor_, TurnoutReferenceCommand::internal_default_instance());
}

}  // namespace

void protobuf_ShutdownFile_TurnoutReferenceCommand_2eproto() {
  TurnoutReferenceCommand_default_instance_.Shutdown();
  delete TurnoutReferenceCommand_reflection_;
}

void protobuf_InitDefaults_TurnoutReferenceCommand_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::modes3::protobuf::protobuf_InitDefaults_Enums_2eproto();
  TurnoutReferenceCommand_default_instance_.DefaultConstruct();
  TurnoutReferenceCommand_default_instance_.get_mutable()->InitAsDefaultInstance();
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_TurnoutReferenceCommand_2eproto_once_);
void protobuf_InitDefaults_TurnoutReferenceCommand_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_TurnoutReferenceCommand_2eproto_once_,
                 &protobuf_InitDefaults_TurnoutReferenceCommand_2eproto_impl);
}
void protobuf_AddDesc_TurnoutReferenceCommand_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_TurnoutReferenceCommand_2eproto();
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_TurnoutReferenceCommand_2eproto_once_);
void protobuf_AddDesc_TurnoutReferenceCommand_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_TurnoutReferenceCommand_2eproto_once_,
                 &protobuf_AddDesc_TurnoutReferenceCommand_2eproto_impl);
}
...
TurnoutReferenceCommand::TurnoutReferenceCommand()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_TurnoutReferenceCommand_2eproto();
  SharedCtor();
...
::google::protobuf::internal::ExplicitlyConstructed<TurnoutReferenceCommand> TurnoutReferenceCommand_default_instance_;
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(TurnoutReferenceCommand, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  &reinterpret_cast<TurnoutReferenceCommand*>(16)->f)
#endif
...
void TurnoutReferenceCommand::UnsafeMergeFrom(const TurnoutReferenceCommand& from) {
