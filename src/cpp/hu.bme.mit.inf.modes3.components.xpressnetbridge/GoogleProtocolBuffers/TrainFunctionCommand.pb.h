...
class TrainFunctionCommand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.TrainFunctionCommand) */ {
 public:
  ...
  static const TrainFunctionCommand* internal_default_instance();

  void Swap(TrainFunctionCommand* other);

  // implements Message ----------------------------------------------

  inline TrainFunctionCommand* New() const { return New(NULL); }
  ...
  void UnsafeMergeFrom(const TrainFunctionCommand& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_TrainFunctionCommand_2eproto_impl();
  friend void  protobuf_AddDesc_TrainFunctionCommand_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<TrainFunctionCommand> TrainFunctionCommand_default_instance_;
