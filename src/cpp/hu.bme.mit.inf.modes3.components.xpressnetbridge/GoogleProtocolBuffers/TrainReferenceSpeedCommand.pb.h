...
class TrainReferenceSpeedCommand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.TrainReferenceSpeedCommand) */ {
 public:
  ...
  static const TrainReferenceSpeedCommand* internal_default_instance();

  void Swap(TrainReferenceSpeedCommand* other);

  // implements Message ----------------------------------------------

  inline TrainReferenceSpeedCommand* New() const { return New(NULL); }
  ...
  void UnsafeMergeFrom(const TrainReferenceSpeedCommand& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_TrainReferenceSpeedCommand_2eproto_impl();
  friend void  protobuf_AddDesc_TrainReferenceSpeedCommand_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<TrainReferenceSpeedCommand> TrainReferenceSpeedCommand_default_instance_;
