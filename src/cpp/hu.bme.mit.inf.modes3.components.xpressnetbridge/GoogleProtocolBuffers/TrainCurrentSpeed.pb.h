...
class TrainCurrentSpeed : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.TrainCurrentSpeed) */ {
 public:
  ...
  static const TrainCurrentSpeed* internal_default_instance();

  void Swap(TrainCurrentSpeed* other);

  // implements Message ----------------------------------------------

  inline TrainCurrentSpeed* New() const { return New(NULL); }

  TrainCurrentSpeed* New(::google::protobuf::Arena* arena) const;
  ...
  void UnsafeMergeFrom(const TrainCurrentSpeed& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_TrainCurrentSpeed_2eproto_impl();
  friend void  protobuf_AddDesc_TrainCurrentSpeed_2eproto_impl();
  friend void protobuf_AssignDesc_TrainCurrentSpeed_2eproto();
  friend void protobuf_ShutdownFile_TrainCurrentSpeed_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<TrainCurrentSpeed> TrainCurrentSpeed_default_instance_;
