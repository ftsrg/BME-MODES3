...
class DccOperationsState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.DccOperationsState) */ {
 public:
  ...
  static const DccOperationsState* internal_default_instance();
  ...
  void UnsafeMergeFrom(const DccOperationsState& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_DccOperationsState_2eproto_impl();
  friend void  protobuf_AddDesc_DccOperationsState_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<DccOperationsState> DccOperationsState_default_instance_;
