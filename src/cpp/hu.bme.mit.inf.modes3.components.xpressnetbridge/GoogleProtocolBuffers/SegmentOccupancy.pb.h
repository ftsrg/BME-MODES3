...
class SegmentOccupancy : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.SegmentOccupancy) */ {
 public:
  ...
  static const SegmentOccupancy* internal_default_instance();
  ...
  void UnsafeMergeFrom(const SegmentOccupancy& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_SegmentOccupancy_2eproto_impl();
  friend void  protobuf_AddDesc_SegmentOccupancy_2eproto_impl();
  friend void protobuf_AssignDesc_SegmentOccupancy_2eproto();
  friend void protobuf_ShutdownFile_SegmentOccupancy_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<SegmentOccupancy> SegmentOccupancy_default_instance_;
