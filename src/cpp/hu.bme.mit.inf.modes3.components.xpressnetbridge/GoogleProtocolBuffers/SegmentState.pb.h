...
class SegmentState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.SegmentState) */ {
 public:
  ...
  static const SegmentState* internal_default_instance();

  void Swap(SegmentState* other);

  // implements Message ----------------------------------------------

  inline SegmentState* New() const { return New(NULL); }

  SegmentState* New(::google::protobuf::Arena* arena) const;
  ...
  void UnsafeMergeFrom(const SegmentState& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_SegmentState_2eproto_impl();
  friend void  protobuf_AddDesc_SegmentState_2eproto_impl();
  friend void protobuf_AssignDesc_SegmentState_2eproto();
  friend void protobuf_ShutdownFile_SegmentState_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<SegmentState> SegmentState_default_instance_;
